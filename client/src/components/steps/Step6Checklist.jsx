...
const CHECKLIST_ITEMS = [
  ...
  { key: 'labelCreate',        label: 'Label creation (POST /v1/labels)' },
  ...
  { key: 'trackingUpdates',    label: 'Tracking query (GET /v1/labels/{id}/track)' },
...
const ENDPOINT_SOURCES = [
  {
    ...
    sandboxSource: 'ShipEngine sandbox API',
    liveSource: 'ShipEngine live API',
    reason: 'ShipEngine has a real /v1/addresses/validate endpoint. Works in sandbox and live.',
    verified: true,
  },
  {
    ...
    sandboxSource: 'ShipEngine sandbox API',
    liveSource: 'ShipEngine live API',
    reason: 'Returns your actual carrier accounts. Sandbox pre-configures UPS, FedEx, USPS.',
    verified: true,
  },
  {
  ...
  },
  {
    ...
    sandboxSource: 'ShipEngine sandbox API (real test label)',
    liveSource: 'ShipEngine live API (real label, costs money)',
    reason: 'Single-call label creation. Sandbox returns a real watermarked PDF you can download.',
    verified: true,
  },
  {
  ...
  },
  {
    ...
    liveSource: 'ShipEngine live API',
    reason: 'ShipEngine sandbox explicitly does not support webhooks. Works in live mode.',
    verified: false,
  },
  {
    ...
    reason: 'Your listener endpoint. ShipEngine calls it. Always local — test with curl.',
    verified: true,
  },
];
  ...
  return (
    <div className="max-w-3xl space-y-6">
      <div>
        ...
        <p className="text-gray-500 mt-1 text-sm">End-to-end verification checklist for ShipEngine integration.</p>
      </div>
      ...
      <div className="step-card space-y-3">
                ...
                <tr key={row.endpoint} className="hover:bg-gray-50">
                  ...
                  <td className="border border-gray-200 px-3 py-2">
                    <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ${
                      ...
                      {row.sandboxSource.includes('NOT') ? 'Not supported' : 'ShipEngine sandbox'}
                    </span>
                  </td>
                  <td className="border border-gray-200 px-3 py-2">
                    <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium ${
                      ...
                      {row.liveSource.includes('Local') ? 'Local receiver' : 'ShipEngine live'}
                    </span>
                  </td>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-3 text-xs text-green-800 space-y-1">
          ...
          <ul className="list-disc list-inside space-y-0.5 text-green-700">
            <li>All critical endpoints (address, rates, label, void, track) hit the real ShipEngine API code paths in sandbox.</li>
...
{`# Sandbox — real ShipEngine API, no charges, TEST_ key
SHIPENGINE_API_KEY=TEST_riR2NOpc7kwMG6acpPc2xYAfRYM4MNkDOWs63b3vac8
MODE=sandbox

# Live — production, real labels, real money
SHIPENGINE_API_KEY=your_production_key_from_dashboard.shipengine.com
MODE=live
